...
case class B42(value: Boolean) extends CtBoxIdentifier("MRR or SCR Claimed") with CtBoolean with Calculated

object B42 {

  def calculate(boxRetriever: CT600BoxRetriever): B42 = {
