...
case class B56(value: BigDecimal) extends CtBoxIdentifier("Tax") with CtBigDecimal with Calculated

object B56 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600BoxRetriever): B56 =
    corporationTaxFy2(
