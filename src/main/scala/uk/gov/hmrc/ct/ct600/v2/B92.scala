...
case class B92(value: BigDecimal) extends CtBoxIdentifier("Corporation Tax outstanding") with CtBigDecimal with Calculated

object B92 extends CorporationTaxAlreadyPaidCalculator {

  def calculate(fieldValueRetriever: CT600BoxRetriever): B92 =
