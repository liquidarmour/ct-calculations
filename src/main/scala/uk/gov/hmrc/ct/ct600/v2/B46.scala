...
case class B46(value: BigDecimal) extends CtBoxIdentifier("Tax") with CtBigDecimal with Calculated

object B46 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600BoxRetriever): B46 =
