...
case class B70(value: BigDecimal) extends CtBoxIdentifier("Corporation Tax Chargeable") with CtBigDecimal with Calculated

object B70 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600BoxRetriever): B70 =
