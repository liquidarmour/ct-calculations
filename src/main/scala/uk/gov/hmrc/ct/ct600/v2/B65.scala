...
case class B65(value: BigDecimal) extends CtBoxIdentifier("Corporation Tax net of MRR") with CtBigDecimal with Calculated

object B65 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600BoxRetriever): B65 =
