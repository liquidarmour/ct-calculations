...
//was B54
case class B385(value: Int) extends CtBoxIdentifier("Amount of Profit FY2") with CtInteger with Calculated

object B385 extends CorporationTaxCalculator {
   ...
   */
  def calculate(fieldValueRetriever: ComputationsBoxRetriever): B385 = {
