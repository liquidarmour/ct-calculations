...
case class E1045(value: BigDecimal) extends CtBoxIdentifier("Second Financial Year Rate Of Tax")
  with CtBigDecimal
  with AnnualConstant
  with Calculated

object E1045 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600EBoxRetriever): E1045 =
