...
case class E1035(value: BigDecimal) extends CtBoxIdentifier(name = "First Financial Year Rate Of Tax") with AnnualConstant with CtBigDecimal with Calculated

object E1035 extends CorporationTaxCalculator {

  def calculate(fieldValueRetriever: CT600EBoxRetriever): E1035 =
