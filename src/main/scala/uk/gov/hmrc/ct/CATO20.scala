...
case class CATO20(value: Int) extends CtBoxIdentifier(name = "UnclaimedAIA_FYA") with CtInteger with NotInPdf with Calculated

object CATO20 extends MachineryAndPlantCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): CATO20 = {
