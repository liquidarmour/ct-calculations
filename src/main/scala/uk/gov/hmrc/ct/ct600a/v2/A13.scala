...
case class A13(value: Option[BigDecimal]) extends CtBoxIdentifier(name = "A13 - Tax payable under S419 ICTA 1988") with CtOptionalBigDecimal with Calculated

object A13 extends LoansToParticipatorsCalculator {

  def calculate(fieldValueRetriever: CT600ABoxRetriever): A13 = {
