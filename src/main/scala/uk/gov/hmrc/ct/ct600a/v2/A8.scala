...
object A8 extends LoansToParticipatorsCalculator {

  def calculate(fieldValueRetriever: CT600ABoxRetriever): A8 = {
    import fieldValueRetriever._
    calculateA8(computationsBoxRetriever.cp2(), lp02(), lpq07())
  }
}
