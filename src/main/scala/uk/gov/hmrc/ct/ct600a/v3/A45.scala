...
object A45 extends LoansToParticipatorsCalculator {

 def calculate(fieldValueRetriever: CT600ABoxRetriever, computationsBoxRetriever: ComputationsBoxRetriever): A45 = {
  calculateA45(fieldValueRetriever.a40(), fieldValueRetriever.loansToParticipators(), computationsBoxRetriever.cp2())
 }
}
