...
object A30 extends LoansToParticipatorsCalculator {
  ...
  def calculate(fieldValueRetriever: CT600ABoxRetriever, computationsBoxRetriever: ComputationsBoxRetriever): A30 = {
    calculateA30(computationsBoxRetriever.cp2(), fieldValueRetriever.loansToParticipators())
  }
}
