...
object A70Inverse extends LoansToParticipatorsCalculator {
  ...
  def calculate(fieldValueRetriever: CT600ABoxRetriever, computationsBoxRetriever: ComputationsBoxRetriever): A70Inverse = {
    calculateA70Inverse(fieldValueRetriever.a65Inverse(), fieldValueRetriever.loansToParticipators(), computationsBoxRetriever.cp2(), fieldValueRetriever.lpq07())
  }
}
