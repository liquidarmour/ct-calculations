...
object A70 extends LoansToParticipatorsCalculator {
 ...
 def calculate(fieldValueRetriever: CT600ABoxRetriever): A70 = {
  calculateA70(fieldValueRetriever.a65(), fieldValueRetriever.loansToParticipators(), fieldValueRetriever.computationsBoxRetriever.cp2(), fieldValueRetriever.lpq07())
 }
}
