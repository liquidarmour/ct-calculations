...
object A70 extends LoansToParticipatorsCalculator {

 def calculate(fieldValueRetriever: CT600ABoxRetriever, computationsBoxRetriever: ComputationsBoxRetriever): A70 = {
  calculateA70(fieldValueRetriever.a65(), fieldValueRetriever.loansToParticipators(), computationsBoxRetriever.cp2(), fieldValueRetriever.lpq07())
 }
}
