...
case class CATO15(value: Int) extends CtBoxIdentifier(name = "Property Expenses") with CtInteger with NotInPdf with Calculated

object CATO15 extends ExpensesCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): CATO15 = {
