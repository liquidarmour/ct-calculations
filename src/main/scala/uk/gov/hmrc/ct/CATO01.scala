...
case class CATO01(value: Int) extends CtBoxIdentifier(name = "VarA - Non trade income") with CtInteger with Calculated

object CATO01 extends NonTradeIncomeCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): CATO01 = {
