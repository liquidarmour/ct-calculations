...
case class LEC13(value: Boolean) extends CtBoxIdentifier("Disposals Less Than Main Rate Pool") with CtBoolean with Calculated

object LEC13 extends LowEmissionCarsCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): LEC13 =
