...
case class CP44(value: Int) extends CtBoxIdentifier(name = "Profit or losses before tax") with CtInteger with Calculated

object CP44 extends ProfitAndLossCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): CP44 = {
