...
case class
CP118(value: Int) extends CtBoxIdentifier(name = "Adjusted Trading Loss") with CtInteger with MustBeZeroOrPositive with Calculated

object CP118 extends AdjustedTradingProfitOrLossCalculator {

  def calculate(fieldValueRetriever: ComputationsBoxRetriever): CP118 = {
