...
object AC17 extends ProfitOrLossCalculator {
  def calculate(boxRetriever: Frsse2008AccountsBoxRetriever, filingAttributesBoxValueRetriever: FilingAttributesBoxValueRetriever): AC17 = {
    calculatePreviousGrossProfitOrLoss(ac13 = boxRetriever.ac13(),
                                       ac15 = boxRetriever.ac15(),
                                       statutoryAccountsFiling = filingAttributesBoxValueRetriever.statutoryAccountsFiling())
  }
}
