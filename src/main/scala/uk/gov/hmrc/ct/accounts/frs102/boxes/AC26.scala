...
case class AC26(value: Option[Int]) extends CtBoxIdentifier(name = "Operating profit or loss (current PoA)") with CtOptionalInteger with Calculated

object AC26 extends OperatingProfitOrLossCalculator {

  def calculate(boxRetriever: Frs102AccountsBoxRetriever): AC26 = {
    boxRetriever match {
