...
object DirectorsReportEnabled
  extends Calculated[DirectorsReportEnabled, Frs10xAccountsBoxRetriever]
    with DirectorsReportEnabledCalculator {

  override def calculate(boxRetriever: Frs10xAccountsBoxRetriever): DirectorsReportEnabled = {
