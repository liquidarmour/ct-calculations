...
object AC436 extends ProfitOrLossCalculator {
  def calculate(boxRetriever: Frsse2008AccountsBoxRetriever, filingAttributesBoxValueRetriever: FilingAttributesBoxValueRetriever): AC436 = {
    calculatePreviousProfitOrLoss(ac13 = boxRetriever.ac13(), ac406 = boxRetriever.ac406(),
                                  ...
                                  ac35 = boxRetriever.ac35(), filingAttributesBoxValueRetriever.microEntityFiling())
  }
}
