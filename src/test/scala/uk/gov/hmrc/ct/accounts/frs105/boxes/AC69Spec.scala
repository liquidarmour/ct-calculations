...
class AC69Spec extends ValidateAssetsEqualSharesSpec[Frs105AccountsBoxRetriever] with MockFrs105AccountsRetriever {
  ...
  testAssetsEqualToSharesValidation(boxRetriever, filingAttributesBoxValueRetriever)("AC69", AC69.apply)
